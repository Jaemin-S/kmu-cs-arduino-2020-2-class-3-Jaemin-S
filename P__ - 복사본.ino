...
// Event periods
#define _INTERVAL_DIST 5  // [3074] 거리측정주기 (ms)
#define _INTERVAL_SERVO 5 // [3078] 서보제어주기 (ms)
...
////////////////////
  ...
  if(event_dist) {
    ...
    if (control > 0)  duty_target = _DUTY_NEU + 2 * control;
    else duty_target = _DUTY_NEU + 2.5 * control;
